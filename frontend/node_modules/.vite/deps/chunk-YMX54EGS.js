...
function intersect(x0, y0, x1, y1, x22, y22, x32, y32) {
  ...
  if (t6 * t6 < epsilon) return;
  t6 = (x322 * (y0 - y22) - y322 * (x0 - x22)) / t6;
  return [x0 + t6 * x10, y0 + t6 * y10];
}
function cornerTangents(x0, y0, x1, y1, r1, rc, cw) {
  var x01 = x0 - x1, y01 = y0 - y1, lo = (cw ? rc : -rc) / sqrt2(x01 * x01 + y01 * y01), ox = lo * y01, oy = -lo * x01, x11 = x0 + ox, y11 = y0 + oy, x10 = x1 + ox, y10 = y1 + oy, x00 = (x11 + x10) / 2, y00 = (y11 + y10) / 2, dx = x10 - x11, dy = y10 - y11, d22 = dx * dx + dy * dy, r3 = r1 - rc, D2 = x11 * y10 - x10 * y11, d3 = (dy < 0 ? -1 : 1) * sqrt2(max2(0, r3 * r3 * d22 - D2 * D2)), cx0 = (D2 * dy - dx * d3) / d22, cy0 = (-D2 * dx - dy * d3) / d22, cx1 = (D2 * dy + dx * d3) / d22, cy1 = (-D2 * dx + dy * d3) / d22, dx0 = cx0 - x00, dy0 = cy0 - y00, dx1 = cx1 - x00, dy1 = cy1 - y00;
...
function pie_default() {
  ...
  function pie(data) {
    var i3, n3 = (data = array_default2(data)).length, j3, k4, sum3 = 0, index2 = new Array(n3), arcs = new Array(n3), a0 = +startAngle.apply(this, arguments), da = Math.min(tau, Math.max(-tau, endAngle.apply(this, arguments) - a0)), a1, p3 = Math.min(Math.abs(da) / n3, padAngle.apply(this, arguments)), pa = p3 * (da < 0 ? -1 : 1), v4;
    for (i3 = 0; i3 < n3; ++i3) {
      if ((v4 = arcs[index2[i3] = i3] = +value(data[i3], i3, data)) > 0) {
        sum3 += v4;
      }
    }
    if (sortValues != null) index2.sort(function(i4, j4) {
      return sortValues(arcs[i4], arcs[j4]);
    });
    else if (sort2 != null) index2.sort(function(i4, j4) {
      return sort2(data[i4], data[j4]);
    });
    for (i3 = 0, k4 = sum3 ? (da - n3 * pa) / sum3 : 0; i3 < n3; ++i3, a0 = a1) {
      j3 = index2[i3], v4 = arcs[j3], a1 = a0 + (v4 > 0 ? v4 * k4 : 0) + pa, arcs[j3] = {
        data: data[j3],
        index: i3,
        value: v4,
        startAngle: a0,
...
var _n = function(e6) {
  var r3 = e6.width, t6 = e6.height, n3 = e6.axis, i3 = e6.scale, o3 = e6.value, l3 = e6.lineStyle, a3 = e6.textStyle, d3 = e6.legend, s4 = e6.legendPosition, u3 = void 0 === s4 ? "top-right" : s4, c9 = e6.legendOffsetX, f3 = void 0 === c9 ? 14 : c9, p3 = e6.legendOffsetY, h2 = void 0 === p3 ? 14 : p3, g3 = e6.legendOrientation, b3 = void 0 === g3 ? "horizontal" : g3, m4 = zt(), y4 = 0, v4 = 0, _ = 0, w3 = 0;
  "y" === n3 ? (_ = i3(o3), v4 = r3) : (y4 = i3(o3), w3 = t6);
  var k4 = null;
  if (d3) {
    var R = function(e7) {
    ...
    }({ axis: n3, width: r3, height: t6, position: u3, offsetX: f3, offsetY: h2, orientation: b3 });
    k4 = (0, import_jsx_runtime.jsx)("text", { transform: "translate(" + R.x + ", " + R.y + ") rotate(" + R.rotation + ")", textAnchor: R.textAnchor, dominantBaseline: "central", style: a3, children: d3 });
  }
  return (0, import_jsx_runtime.jsxs)("g", { transform: "translate(" + y4 + ", " + _ + ")", children: [(0, import_jsx_runtime.jsx)("line", { x1: 0, x2: v4, y1: 0, y2: w3, stroke: m4.markers.lineColor, strokeWidth: m4.markers.lineStrokeWidth, style: l3 }), k4] });
};
...
var Pn = function(e6, r3, t6, n3) {
  var i3 = Math.atan2(n3 - r3, t6 - e6) - Math.PI / 2;
...
var X = function(i3) {
  var n3, l3, a3, d3, g3, f3, m4, v4, u3, y4, k4, x4 = i3.x, b3 = i3.y, A3 = i3.width, W2 = i3.height, z3 = i3.data, C4 = i3.direction, X2 = void 0 === C4 ? "left-to-right" : C4, Y2 = i3.justify, O4 = void 0 !== Y2 && Y2, B3 = i3.textColor, H2 = i3.background, E3 = void 0 === H2 ? "transparent" : H2, j3 = i3.opacity, L = void 0 === j3 ? 1 : j3, M2 = i3.symbolShape, F2 = void 0 === M2 ? "square" : M2, T2 = i3.symbolSize, P2 = void 0 === T2 ? 16 : T2, V2 = i3.symbolSpacing, R = void 0 === V2 ? 8 : V2, D2 = i3.symbolBorderWidth, q2 = void 0 === D2 ? 0 : D2, G = i3.symbolBorderColor, I = void 0 === G ? "transparent" : G, N2 = i3.onClick, _ = i3.onMouseEnter, J = i3.onMouseLeave, K2 = i3.toggleSerie, Q = i3.effects, U = (0, import_react18.useState)({}), Z = U[0], $ = U[1], tt2 = zt(), et2 = (0, import_react18.useCallback)(function(t6) {
    ...
    null == J || J(z3, t6);
  }, [J, z3, Q]), nt2 = S({ direction: X2, justify: O4, symbolSize: null != (n3 = Z.symbolSize) ? n3 : P2, symbolSpacing: R, width: A3, height: W2 }), ot2 = nt2.symbolX, rt2 = nt2.symbolY, lt2 = nt2.labelX, at2 = nt2.labelY, ct2 = nt2.labelAnchor, dt2 = nt2.labelAlignment, st2 = [N2, _, J, K2].some(function(t6) {
    return void 0 !== t6;
  }), ht2 = "function" == typeof F2 ? F2 : w2[F2];
  return (0, import_jsx_runtime3.jsxs)("g", { transform: "translate(" + x4 + "," + b3 + ")", style: { opacity: null != (l3 = Z.itemOpacity) ? l3 : L }, children: [(0, import_jsx_runtime3.jsx)("rect", { width: A3, height: W2, fill: null != (a3 = Z.itemBackground) ? a3 : E3, style: { cursor: st2 ? "pointer" : "auto" }, onClick: function(t6) {
...
//# sourceMappingURL=chunk-YMX54EGS.js.map
