...
var ListItem = React5.forwardRef(function ListItem2(inProps, ref) {
  ...
  const children = React5.Children.toArray(childrenProp);
  ...
  if (hasSecondaryAction) {
    ...
    return (0, import_jsx_runtime4.jsx)(ListContext_default.Provider, {
      value: childContext,
      children: (0, import_jsx_runtime4.jsxs)(ListItemContainer, {
  ...
  return (0, import_jsx_runtime4.jsx)(ListContext_default.Provider, {
    value: childContext,
    children: (0, import_jsx_runtime4.jsxs)(Root, {
      ...rootProps,
      as: Component,
      ref: handleRef,
      ...!isHostComponent_default(Root) && {
...
true ? ListItem.propTypes = {
  ...
  children: chainPropTypes(import_prop_types4.default.node, (props) => {
    const children = React5.Children.toArray(props.children);
...
//# sourceMappingURL=chunk-PZUWPMFV.js.map
