...
var O = function(t3, e3) {
  ...
  if (B2.forEach(function(e4) {
    ...
    var n4 = O2(e4.value);
    t3.save(), t3.translate(e4.x + e4.textX, e4.y + e4.textY), t3.rotate(Kt(g2)), C2.outlineWidth > 0 && (t3.strokeStyle = C2.outlineColor, t3.lineWidth = 2 * C2.outlineWidth, t3.lineJoin = "round", t3.strokeText("" + n4, 0, 0)), W3.axis.ticks.text.fill && (t3.fillStyle = C2.fill), t3.fillText("" + n4, 0, 0), t3.restore();
  }), void 0 !== p2) {
    var j2 = 0, z2 = 0, V = 0, D = "center";
    "y" === n3 ? (V = -90, j2 = S2, "start" === T2 ? (D = "start", z2 = f) : "middle" === T2 ? (D = "center", z2 = f / 2) : "end" === T2 && (D = "end")) : (z2 = S2, "start" === T2 ? D = "start" : "middle" === T2 ? (D = "center", j2 = f / 2) : "end" === T2 && (D = "end", j2 = f)), t3.translate(j2, z2), t3.rotate(Kt(V)), t3.font = (W3.axis.legend.text.fontWeight ? W3.axis.legend.text.fontWeight + " " : "") + W3.axis.legend.text.fontSize + "px " + W3.axis.legend.text.fontFamily, W3.axis.legend.text.fill && (t3.fillStyle = W3.axis.legend.text.fill), t3.textAlign = D, t3.textBaseline = "middle", t3.fillText(p2, 0, 0);
  }
  t3.restore();
};
...
//# sourceMappingURL=chunk-BZUKPWHF.js.map
