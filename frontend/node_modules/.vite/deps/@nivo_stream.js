import {
  ...
  W,
  Y
} from "./chunk-BZUKPWHF.js";
import "./chunk-OBRV7NRQ.js";
import {
  C,
  Fr,
  In,
...
var J = function(o2) {
  var r2 = o2.data, n = o2.keys, l = o2.label, h = o2.valueFormat, y = o2.offsetType, C3 = o2.order, B2 = o2.curve, W2 = o2.layers, k2 = void 0 === W2 ? V.layers : W2, S = o2.width, O2 = o2.height, w3 = o2.margin, I2 = o2.axisTop, E2 = o2.axisRight, H2 = o2.axisBottom, Y3 = void 0 === H2 ? V.axisBottom : H2, q2 = o2.axisLeft, J2 = void 0 === q2 ? V.axisLeft : q2, K2 = o2.enableGridX, N2 = void 0 === K2 ? V.enableGridX : K2, Q = o2.enableGridY, U = void 0 === Q ? V.enableGridY : Q, Z = o2.colors, $ = o2.fillOpacity, _ = void 0 === $ ? V.fillOpacity : $, oo = o2.borderWidth, eo = void 0 === oo ? V.borderWidth : oo, ro = o2.borderColor, to = o2.defs, io = void 0 === to ? V.defs : to, no = o2.fill, lo = void 0 === no ? V.fill : no, ao = o2.enableDots, co = void 0 === ao ? V.enableDots : ao, so = o2.dotPosition, uo = void 0 === so ? V.dotPosition : so, fo = o2.dotComponent, ho = void 0 === fo ? V.dotComponent : fo, po = o2.dotSize, vo = o2.dotColor, mo = o2.dotBorderWidth, yo = o2.dotBorderColor, go = o2.isInteractive, bo = void 0 === go ? V.isInteractive : go, xo = o2.tooltip, Co = void 0 === xo ? V.tooltip : xo, Bo = o2.enableStackTooltip, Wo = void 0 === Bo ? V.enableStackTooltip : Bo, ko = o2.stackTooltip, So = void 0 === ko ? V.stackTooltip : ko, Oo = o2.legends, To = void 0 === Oo ? V.legends : Oo, wo = o2.role, Io = o2.ariaLabel, Do = o2.ariaLabelledBy, Lo = o2.ariaDescribedBy, Mo = wt(S, O2, w3), zo = Mo.margin, Fo = Mo.innerWidth, Go = Mo.innerHeight, jo = Mo.outerWidth, Eo = Mo.outerHeight, Po = function(o3) {
    var e2 = o3.width, r3 = o3.height, i2 = o3.data, n2 = o3.keys, l2 = o3.label, h2 = void 0 === l2 ? R.label : l2, p = o3.valueFormat, v = o3.offsetType, m = void 0 === v ? R.offsetType : v, y2 = o3.order, g2 = void 0 === y2 ? R.order : y2, b = o3.curve, x = void 0 === b ? R.curve : b, C4 = o3.colors, B3 = void 0 === C4 ? R.colors : C4, W3 = o3.borderColor, k3 = void 0 === W3 ? R.borderColor : W3, S2 = o3.dotSize, O3 = void 0 === S2 ? R.dotSize : S2, T2 = o3.dotColor, w4 = void 0 === T2 ? R.dotColor : T2, I3 = o3.dotBorderWidth, E3 = void 0 === I3 ? R.dotBorderWidth : I3, P2 = o3.dotBorderColor, H3 = void 0 === P2 ? R.dotBorderColor : P2, X2 = bt(x), Y4 = (0, import_react.useMemo)(function() {
...
var K = function(o2) {
  var e2 = o2.isInteractive, r2 = void 0 === e2 ? V.isInteractive : e2, t2 = o2.animate, i2 = void 0 === t2 ? V.animate : t2, n = o2.motionConfig, l = void 0 === n ? V.motionConfig : n, a = o2.theme, d = o2.renderWrapper, c = function(o3, e3) {
    if (null == o3) return {};
